...
var
 ...
 iOldLevel, iNewLevel, iShift, iBase, iHealth, iHealthPlus, iStam, iStamPlus, iMgk, iMgkPlus, iMult, iCheckMult, iMaxMult : integer;
...
// NPC Scaling begins here
	...
	// This changes Starting Health, Stamina and Magicka value of races.	

		// NPC initial health is usually Offset + Starting health. 
		// Offset is only true if leven is not scaled to PC.
		// This means if starting health is left untouched, every NPC will have halved health values at least.
		// To avoid initial very small values..
		// In this script we grab starting value, split it and then add it to itself.
